...
export default function MonteSuaCaixaClient() {
  ...
  const handleAddToBag = () => {
    ...
    const flavorNames = selectedFlavors
      .map((id) => saboresDisponiveis.find((f) => f.id === id)?.name)
      .filter(Boolean)
      .join(", ")
          ...
          <div className="lg:col-span-2 space-y-12">
                    ...
                    {sizeOptions.map((size) => (
                      ...
                      >
                        <div className="text-center">
                          ...
                          <p className="text-2xl font-bold">R$ {(unitPrice * size.quantity).toFixed(2)}</p>
                        </div>
                      </Card>
                    ))}
                  </div>
            ...
            <div className="flex items-center justify-between pt-4">
              ...
              {currentStep < totalSteps ? (
                ...
                <Button
                  className="bg-primary hover:bg-primary/90 transition-all duration-300 ease-in-out"
                  disabled={selectedFlavors.length === 0 || !selectedSize || (isTrufas && !truffleType)}
            ...
            <Card className="p-6 sticky top-24 border-2">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{selectedFlavors.length} / 4</span>
                </div>
              </div>
